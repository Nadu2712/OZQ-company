...
namespace OZQ_company
{
    public partial class AddGender : System.Web.UI.Page
    {
        ...
        {
            using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["OZQCompanyDB"].ConnectionString))
            {
        ...
        {
            using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["OZQComapnyDB"].ConnectionString))
            {
                con.Open();
